...
numberKeywordDataset <- 50   # target number of keywords appearing in the keyword figure for combined dataset
numberKeywordIfsms <- 28   # target number of keywords appearing in the keyword figure for IFSMS

numberMaxKeywordDataset <- 57  # maximum number of keywords appearing in the keyword figure
